...
class AuthService(
    ...
    @Value("\${blackcat.package.default-admin.enabled:false}")
    private var packagedDefaultAdminEnabled: Boolean = false

    @Value("\${blackcat.package.default-admin.username:123456}")
    private lateinit var packagedDefaultAdminUsername: String

    @Value("\${blackcat.package.default-admin.password:123456}")
