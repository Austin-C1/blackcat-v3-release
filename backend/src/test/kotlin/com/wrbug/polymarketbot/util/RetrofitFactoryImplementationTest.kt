...
class RetrofitFactoryImplementationTest {
    ...
    @Test
    fun `retrofit factory should not keep PolyHermes placeholder urls`() {
        val source = Files.readString(sourcePath)

        assertFalse(
            source.contains("https://polyrpc.polyhermes/"),
            "RetrofitFactory should use a neutral RPC placeholder instead of the old PolyHermes host"
        )
