...
import type { ApiResponse, CopyTradingStatistics, CopyTradingStatisticsBatchResponse, MarketBettingEventDetail, MarketBettingSearchResponse, NotificationConfig, NotificationConfigRequest, NotificationConfigUpdateRequest, NotificationTemplate, TemplateTypeInfo, TemplateVariablesResponse } from '../types'
...
type AccountSetupStatusResponse = {
...
export const apiService = {
  ...
  users: {
     ...
     */
    list: () =>
      apiClient.post<ApiResponse<UserDto[]>>('/system/users/list', {}),
    
    /**
     * 创建用户
     */
    create: (data: { username: string; password: string }) =>
      apiClient.post<ApiResponse<void>>('/system/users/create', data),
  ...
  accounts: {
    ...
    checkProxyOptions: (data: any) =>
      apiClient.post<ApiResponse<import('../types').CheckProxyOptionsResponse>>('/accounts/check-proxy-options', data),
    
    /**
     * 导入账户
     */
    import: (data: any) =>
      apiClient.post<ApiResponse<import('../types').Account>>('/accounts/import', data),
    
    /**
     * 检查账户设置状态
     */
    checkSetupStatus: (accountId: number) =>
      apiClient.post<ApiResponse<AccountSetupStatusResponse>>('/accounts/check-setup-status', { accountId }),

    /**
     * 执行设置步骤（步骤1 返回跳转 URL，步骤2/3 由后端执行）
     */
    executeSetupStep: (accountId: number, step: number) =>
      apiClient.post<ApiResponse<ExecuteSetupStepResponse>>(
     ...
     * 更新账户
     */
    update: (data: import('../types').AccountUpdateRequest) =>
      apiClient.post<ApiResponse<import('../types').Account>>('/accounts/update', data),
     ...
     */
    list: () => 
      apiClient.post<ApiResponse<import('../types').AccountListResponse>>('/accounts/list', {}),
    
    /**
     * 查询账户详情
     */
    detail: (data: { accountId?: number }) => 
      apiClient.post<ApiResponse<import('../types').Account>>('/accounts/detail', data),
    
    /**
     * 查询账户余额
     */
    balance: (data: { accountId?: number }) => 
      apiClient.post<ApiResponse<import('../types').AccountBalanceResponse>>('/accounts/balance', data),
    
    /**
     * 查询所有账户的仓位列表
     */
    positionsList: () => 
      apiClient.post<ApiResponse<import('../types').PositionListResponse>>('/accounts/positions/list', {}),
    
    /**
     * 卖出仓位
     */
    sellPosition: (data: any) => 
      apiClient.post<ApiResponse<import('../types').PositionSellResponse>>('/accounts/positions/sell', data),
    
    /**
     * 获取可赎回仓位统计
     */
    getRedeemableSummary: (data: { accountId?: number }) => 
      apiClient.post<ApiResponse<import('../types').RedeemablePositionsSummary>>('/accounts/positions/redeemable-summary', data),
    
    /**
     * 赎回仓位
     */
    redeemPositions: (data: any) => 
      apiClient.post<ApiResponse<import('../types').PositionRedeemResponse>>('/accounts/positions/redeem', data),
  ...
  markets: {
    ...
    getMarketPrice: (data: { marketId: string; outcomeIndex?: number }) => 
      apiClient.post<ApiResponse<import('../types').MarketPriceResponse>>('/markets/price', data),
    
    /**
     * 获取最新价（从订单表获取，供前端下单时显示）
     */
    getLatestPrice: (data: { tokenId: string }) => 
      apiClient.post<ApiResponse<import('../types').MarketPriceResponse>>('/markets/latest-price', data)
  },
  ...
  leaders: {
     ...
     * 添加 Leader
     */
    add: (data: { leaderAddress: string; leaderName?: string; remark?: string; website?: string; category?: string; customGroup?: string }) =>
      apiClient.post<ApiResponse<import('../types').Leader>>('/copy-trading/leaders/add', data),

    /**
     * 更新 Leader
     */
    update: (data: { leaderId: number; leaderName?: string; remark?: string; website?: string; category?: string; customGroup?: string }) =>
      apiClient.post<ApiResponse<import('../types').Leader>>('/copy-trading/leaders/update', data),
    ...
    list: (data: { category?: string } = {}) =>
      apiClient.post<ApiResponse<import('../types').LeaderListResponse>>('/copy-trading/leaders/list', data),

    /**
     * 查询 Leader 详情
     */
    detail: (data: { leaderId: number }) =>
      apiClient.post<ApiResponse<import('../types').Leader>>('/copy-trading/leaders/detail', data),

    /**
     * 查询 Leader 余额
     */
    balance: (data: { leaderId: number }) =>
      apiClient.post<ApiResponse<import('../types').LeaderBalanceResponse>>('/copy-trading/leaders/balance', data)
  },
  ...
  templates: {
     ...
     */
    create: (data: any) => 
      apiClient.post<ApiResponse<import('../types').CopyTradingTemplate>>('/copy-trading/templates/create', data),
    
    /**
     * 更新模板
     */
    update: (data: any) => 
      apiClient.post<ApiResponse<import('../types').CopyTradingTemplate>>('/copy-trading/templates/update', data),
     ...
     */
    copy: (data: any) => 
      apiClient.post<ApiResponse<import('../types').CopyTradingTemplate>>('/copy-trading/templates/copy', data),
    
    /**
     * 查询模板列表
     */
    list: () => 
      apiClient.post<ApiResponse<import('../types').TemplateListResponse>>('/copy-trading/templates/list', {}),
    
    /**
     * 查询模板详情
     */
    detail: (data: { templateId: number }) => 
      apiClient.post<ApiResponse<import('../types').CopyTradingTemplate>>('/copy-trading/templates/detail', data)
  },
  ...
  copyTrading: {
     ...
     */
    create: (data: any) => 
      apiClient.post<ApiResponse<import('../types').CopyTrading>>('/copy-trading/configs/create', data),
    
    /**
     * 更新跟单配置
     */
    update: (data: any) => 
      apiClient.post<ApiResponse<import('../types').CopyTrading>>('/copy-trading/configs/update', data),
    
    /**
     * 查询跟单列表
     */
    list: (data: { accountId?: number; leaderId?: number; enabled?: boolean } = {}) => 
      apiClient.post<ApiResponse<import('../types').CopyTradingListResponse>>('/copy-trading/configs/list', data),

    detail: (data: { copyTradingId: number }) =>
      apiClient.post<ApiResponse<import('../types').CopyTrading>>('/copy-trading/configs/detail', data),
    
    /**
     * 更新跟单状态（兼容旧接口）
     */
    updateStatus: (data: { copyTradingId: number; enabled: boolean }) => 
      apiClient.post<ApiResponse<void>>('/copy-trading/configs/update-status', data),
    ...
    getAccountTemplates: (data: { accountId: number }) => 
      apiClient.post<ApiResponse<import('../types').AccountTemplatesResponse>>('/copy-trading/configs/account-templates', data),
  ...
  orders: {
     ...
     */
    list: (data: any) => 
      apiClient.post<ApiResponse<import('../types').OrderListResponse>>('/copy-trading/orders/list', data),
  ...
  statistics: {
    ...
    global: (data: { startTime?: number; endTime?: number } = {}) => 
      apiClient.post<ApiResponse<import('../types').Statistics>>('/copy-trading/statistics/global', data),
    
    /**
     * 获取 Leader 统计
     */
    leader: (data: { leaderId: number; startTime?: number; endTime?: number }) => 
      apiClient.post<ApiResponse<import('../types').Statistics>>('/copy-trading/statistics/leader', data),
    
    /**
     * 获取分类统计
     */
    category: (data: { category: string; startTime?: number; endTime?: number }) => 
      apiClient.post<ApiResponse<import('../types').Statistics>>('/copy-trading/statistics/category', data),
    
    /**
     * 获取跟单关系统计详情
     */
    detail: (data: { copyTradingId: number }) => 
      apiClient.post<ApiResponse<CopyTradingStatistics>>('/copy-trading/statistics/detail', data),

    batchDetail: (data: { copyTradingIds: number[] }) =>
      apiClient.post<ApiResponse<CopyTradingStatisticsBatchResponse>>('/copy-trading/statistics/batch-detail', data)
  },
  ...
  orderTracking: {
     ...
     */
    list: (data: any) => 
      apiClient.post<ApiResponse<import('../types').OrderTrackingListResponse>>('/copy-trading/orders/tracking', data),
    
    /**
     * 查询按市场分组的订单列表（买入/卖出）
     */
    listGroupedByMarket: (data: any) =>
      apiClient.post<ApiResponse<unknown>>('/copy-trading/orders/grouped-by-market', data)
  },
  ...
  proxyConfig: {
     ...
     */
    get: () =>
      apiClient.post<ApiResponse<ProxyConfigResponse>>('/system/proxy/get', {}),
    
    /**
     * 获取所有代理配置
     */
    list: () =>
      apiClient.post<ApiResponse<ProxyConfigResponse[]>>('/system/proxy/list', {}),
    ...
    saveHttp: (data: {
      ...
      apiClient.post<ApiResponse<ProxyConfigResponse>>('/system/proxy/http/save', data),
  ...
  largeBetMonitor: {
    getConfig: () =>
      apiClient.post<ApiResponse<import('../types').LargeBetMonitorConfig>>('/system/large-bet-monitor/config', {}),

    updateConfig: (data: import('../types').LargeBetMonitorConfigUpdateRequest) =>
      apiClient.post<ApiResponse<import('../types').LargeBetMonitorConfig>>('/system/large-bet-monitor/config/update', data),

    listRecords: () =>
      apiClient.post<ApiResponse<import('../types').LargeBetWatchRecord[]>>('/system/large-bet-monitor/records/list', {}),

    getStatus: () =>
      apiClient.post<ApiResponse<import('../types').LargeBetMonitorStatus>>('/system/large-bet-monitor/status', {}),

    test: () =>
      apiClient.post<ApiResponse<boolean>>('/system/large-bet-monitor/test', {})
  },
  ...
  systemConfig: {
     ...
     * 更新订单推送最小金额
     */
    updateOrderNotificationMinAmount: (data: { minAmountUsdc: string }) =>
      apiClient.post<ApiResponse<import('../types').SystemConfig>>('/system/config/order-notification-min-amount/update', data),
  ...
  rpcNodes: {
    ...
    checkHealth: (data: { id?: number }) =>
      apiClient.post<ApiResponse<void>>('/system/rpc-nodes/check-health', data),
